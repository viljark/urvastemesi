...
const TemplateWrapper = ({ children }) => (
  <div>
    <Helmet>
      ...
      <meta name="description" content="Mee ja mesilasperede müük - Urvaste Mesi OÜ"/>
      ...
      <meta property="og:title" content="Mee ja mesilasperede müük - Urvaste Mesi OÜ"/>
      <meta property="og:description" content="Mee ja mesilasperede müük - Urvaste Mesi OÜ"/>
    </Helmet>
    <Navbar/>
    <div>{children}</div>
  </div>
